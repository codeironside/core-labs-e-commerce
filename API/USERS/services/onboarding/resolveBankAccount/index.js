...
export const resolveOnboardingBankAccount = async (req, res, next) => {
    try {
        ...
        const resolved = await resolveNigerianBankAccount(parsed.data.bankCode, parsed.data.accountNumber);
