 ...
 */
biometricRouter.post('/register', authenticate, async (req, res, next) => {
    try {
 ...
 */
biometricRouter.post('/challenge', async (req, res, next) => {
    try {
 ...
 */
biometricRouter.post('/login', async (req, res, next) => {
    try {
